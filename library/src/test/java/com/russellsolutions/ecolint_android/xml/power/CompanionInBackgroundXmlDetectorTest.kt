...
class CompanionInBackgroundXmlDetectorTest : LintDetectorTest() {
    ...
    fun testCompanionPermission() {
        lint().ecolint().files(
            ...
            AndroidManifest.xml:5: Warning: Using the permission REQUEST_COMPANION_RUN_IN_BACKGROUND will have a negative effect on the device's battery life. [CompanionBackgroundPermission]
                                <uses-permission android:name="android.permission.REQUEST_COMPANION_RUN_IN_BACKGROUND" />
                                                 ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
            0 errors, 1 warnings
        """.trimIndent())
