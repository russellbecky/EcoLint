...
class ThriftyBluetoothAdvertiseModeDetectorTest : LintDetectorTest() {
    ...
    fun testHighAdvertiseMode() {
        lint().ecolint().files(
            ...
            src/Example.kt:5: Warning: You should call AdvertiseSettings.Builder.setAdvertiseMode(ADVERTISE_MODE_LOW_POWER) or AdvertiseSettings.Builder.setAdvertiseMode(ADVERTISE_TX_POWER_LOW) or AdvertiseSettings.Builder.setAdvertiseMode(ADVERTISE_TX_POWER_ULTRA_LOW) to optimize battery usage. [ThriftyBLEAdvertiseMode]
                                    settings.setAdvertiseMode(AdvertiseSettings.ADVERTISE_MODE_LOW_LATENCY)
                                    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
            0 errors, 1 warnings
        """.trimIndent())
