...
class HighFrameRateDetectorTest : LintDetectorTest() {
    ...
    fun testHighFrameRate() {
        lint().ecolint().files(
            ...
            src/test.kt:4: Warning: To optimize content refresh and save energy, frame rate should be set at maximum 60Hz. [HighFrameRate]
                                view.setFrameRate(120f, 0)
                                ~~~~~~~~~~~~~~~~~~~~~~~~~~
            0 errors, 1 warnings
        """.trimIndent())
    ...
    fun testDetectsHighFrameRate() {
        lint().ecolint().files(
            ...
            src/com/example/app/Example.kt:6: Warning: To optimize content refresh and save energy, frame rate should be set at maximum 60Hz. [HighFrameRate]
                                    surface.setFrameRate(90.0f, 0)
                                    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
            0 errors, 1 warnings
        """.trimIndent())
