...
class BluetoothLowEnergyDetectorTest : LintDetectorTest() {
    ...
    fun testGoogleAnalyticsImport() {
        lint().ecolint().files(
            ...
            src/Example.kt:1: Warning: You are using Bluetooth. Did you take a look at the Bluetooth Low Energy API? [BluetoothLowEnergy]
            import android.bluetooth.BluetoothAdapter
            ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
            src/Example.kt:2: Warning: You are using Bluetooth. Did you take a look at the Bluetooth Low Energy API? [BluetoothLowEnergy]
