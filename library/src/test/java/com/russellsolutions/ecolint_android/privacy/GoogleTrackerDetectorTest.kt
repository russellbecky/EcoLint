...
class GoogleTrackerDetectorTest : LintDetectorTest() {
    ...
    fun testGoogleAnalyticsImport() {
        lint().ecolint().files(
            ...
            src/Example.kt:1: Warning: Using com.google.android.gms.analytics.* or com.google.firebase.analytics.* may introduce privacy concerns. [GoogleTrackerImport]
            import com.google.android.gms.analytics.Tracker
            ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
            src/Example.kt:2: Warning: Using com.google.android.gms.analytics.* or com.google.firebase.analytics.* may introduce privacy concerns. [GoogleTrackerImport]
    ...
    fun testFirebaseAnalyticsImport() {
        lint().ecolint().files(
            ...
            src/Example.kt:2: Warning: Using com.google.android.gms.analytics.* or com.google.firebase.analytics.* may introduce privacy concerns. [GoogleTrackerImport]
                            import com.google.firebase.analytics.FirebaseAnalytics
                            ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
            src/Example.kt:3: Warning: Using com.google.android.gms.analytics.* or com.google.firebase.analytics.* may introduce privacy concerns. [GoogleTrackerImport]
