...
class ThriftyGeolocationCriteriaDetector : Detector(), SourceCodeScanner {
    companion object {
        val ISSUE: Issue = Issue.create(
            ...
            explanation = "Always use `LocationManager.getBestProvider(...)` before requesting location updates, and configure Criteria with `setPowerRequirement(POWER_LOW)` for battery efficiency.",
