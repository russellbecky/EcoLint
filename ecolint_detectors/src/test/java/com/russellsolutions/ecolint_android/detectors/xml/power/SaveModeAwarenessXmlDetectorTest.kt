...
class SaveModeAwarenessXmlDetectorTest : LintDetectorTest() {
    ...
    fun testBatteryChangedIntent() {
        lint().ecolint().files(
            ...
            AndroidManifest.xml:6: Warning: Taking into account when the device is entering or exiting the power save mode is a good practice. [🌱 EcoLint: SaveModeAwareness]
                                            <action android:name="android.intent.action.BATTERY_CHANGED" />
                                            ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
            0 errors, 1 warnings
        """.trimIndent())
