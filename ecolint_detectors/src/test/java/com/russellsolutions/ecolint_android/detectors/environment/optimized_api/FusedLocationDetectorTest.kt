...
class FusedLocationDetectorTest : LintDetectorTest() {
    ...
    fun testAndroidLocationOnly() {
        lint().ecolint().files(
            ...
            src/Example.kt:1: Warning: Use com.google.android.gms.location instead of android.location to maximize battery life. [🌱 EcoLint: FusedLocation]
            import android.location.LocationManager
            ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
            src/Example.kt:2: Warning: Use com.google.android.gms.location instead of android.location to maximize battery life. [🌱 EcoLint: FusedLocation]
