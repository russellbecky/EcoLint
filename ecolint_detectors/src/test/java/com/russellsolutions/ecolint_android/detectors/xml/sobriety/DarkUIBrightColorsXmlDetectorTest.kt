...
class DarkUIBrightColorsXmlDetectorTest : LintDetectorTest() {
    ...
    fun testBrightHexColorsInLayout() {
        lint().ecolint().files(
            ...
            res/layout/test.xml:5: Warning: Avoid using too bright colors for (AM)OLED screens. [🌱 EcoLint: BrightColorUsage]
                                android:textColor="#FFFFFF"
                                ~~~~~~~~~~~~~~~~~~~~~~~~~~~
            res/layout/test.xml:6: Warning: Avoid using too bright colors for (AM)OLED screens. [🌱 EcoLint: BrightColorUsage]
                                android:background="#eeeeee" />
                                ~~~~~~~~~~~~~~~~~~~~~~~~~~~~
            0 errors, 2 warnings
        """.trimIndent())
