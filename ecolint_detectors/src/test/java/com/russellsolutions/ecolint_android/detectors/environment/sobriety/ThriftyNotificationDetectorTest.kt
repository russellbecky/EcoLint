...
class ThriftyNotificationDetectorTest : LintDetectorTest() {
    ...
    fun testNonNullSoundOrVibration() {
        ...
        ).skipTestModes(TestMode.SUPPRESSIBLE).run().expectWarningCount(4).expect("""
            src/Example.kt:7: Warning: Avoid using vibration or sound when notifying the users to use less energy. [🌱 EcoLint: ThriftyNotification]
                                    channel.setSound(Uri.parse("content://sound"))
                                    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
            src/Example.kt:8: Warning: Avoid using vibration or sound when notifying the users to use less energy. [🌱 EcoLint: ThriftyNotification]
                                    channel.setVibrationPattern(longArrayOf(0, 100))
                                    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
            src/Example.kt:9: Warning: Avoid using vibration or sound when notifying the users to use less energy. [🌱 EcoLint: ThriftyNotification]
                                    builder.setSound(Uri.parse("content://sound"))
                                    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
            src/Example.kt:10: Warning: Avoid using vibration or sound when notifying the users to use less energy. [🌱 EcoLint: ThriftyNotification]
                                    builder.setVibrate(longArrayOf(100, 200))
                                    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
            0 errors, 4 warnings
        """.trimIndent())
