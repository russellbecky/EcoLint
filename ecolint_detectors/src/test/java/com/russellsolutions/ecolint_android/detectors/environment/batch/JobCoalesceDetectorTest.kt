...
class JobCoalesceDetectorTest : LintDetectorTest() {
    ...
    fun testAlarmManagerUsage() {
        lint().ecolint().files(
            ...
            src/Example.kt:5: Warning: Avoid using AlarmManager or SyncAdapter for alarms. Use JobScheduler to allow the system to optimize scheduling. [🌱 EcoLint: JobCoalescing]
                                    alarmManager.set(AlarmManager.RTC_WAKEUP, 1000, null)
                                    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
            0 errors, 1 warnings
        """.trimIndent())
